...
/*   Updated: 2023/04/05 20:32:12 by pnourish         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main()
{
    ...
    printf("ft_memmove result: %s\n", dst2);
    printf("memmove result: %s\n", (char *)memmove(dst12, src12, strlen(src12) + 1));
    assert(memcmp(dst2, dst12, strlen(src12) + 1) == 0);
    ...
    char dst13[] = "hello";
    char src13[] = "world";
    ft_memmove(dst3, src3, strlen(src3));
    printf("ft_memmove result: %s\n", dst3);
    ...
    char dst14[] = "hello";
    char src14[] = "world";
    ft_memmove(dst4 + 2, src4, strlen(src4) + 1);
    printf("ft_memmove result: %s\n", dst4);
    printf("memmove result: %s\n", (char *)memmove(dst14 + 2, src14, strlen(src14) + 1));
